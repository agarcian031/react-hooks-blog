  ...
  const rightNavItems = () => {
    ...
    if (user) {
      ...
      return (
        <Menu.Menu position="right">
          <Link to="/login">
            <Menu.Item id="login" name="login" active={location.pathname === "/login"} />
          </Link>
          <Link to="/register">
            <Menu.Item id="register" name="register" active={location.pathname === "/register"} />
          </Link>
        </Menu.Menu>
      );
    }
  ...
  return (
    <div>
      <Menu pointing secondary>
        ...
        <Link to="/blogs">
          <Menu.Item name="blogs" id="blogs" active={location.pathname === "/blogs"} />
        </Link>
        {rightNavItems()}
      </Menu>
    </div>
